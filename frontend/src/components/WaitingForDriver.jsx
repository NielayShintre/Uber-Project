...
const WaitingForDriver = (props) => {
  return (
    <div>
      ...
      >
        <img className="text-3xl text-gray-800" src={arrowdown} />
      </h5>
      <h2 className="text-2xl font-semibold mb-3">Waiting for a driver</h2>
      <div className="flex items-center justify-between">
        ...
        <div className="text-right">
          ...
          <h4 className="text-xl font-semibold -mt-1 -mb-1">BLR43532</h4>
